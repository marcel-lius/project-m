...
const Footer = () => {
    ...
    return (
        <footer className="footer absolute w-full bottom-0 bg-grainy">
            ...
            <div className="relative z-10 flex items-center justify-between px-8 py-6">
                ...
                <p className="text-background text-md font-semibold text-center">
                    Built with <span className="text-broken-white font-bold">Next.js</span>, <span className="text-broken-white font-bold">Tailwind CSS</span>, and <span className="text-broken-white font-bold">GSAP</span>, deployed with <span className="text-broken-white font-bold">Vercel</span>.<br/>
                    Using <span className="text-broken-white font-bold">Github Copilot</span> and <span className="text-broken-white font-bold">Cursor</span> assisstance.
                </p>
                <div className="flex gap-4">
                    <a href="https://www.linkedin.com/in/marcellius-lim/" target="_blank" rel="noopener noreferrer" className="text-onyx-900 hover:opacity-70 transition-opacity">
                        <FaLinkedinIn size={20} />
                    </a>
                    <a href="https://github.com/marcel-lius" target="_blank" rel="noopener noreferrer" className="text-onyx-900 hover:opacity-70 transition-opacity">
                        <FaGithub size={20} />
                    </a>
                    <a href="https://www.hackerrank.com/profile/marcellius_lim" target="_blank" rel="noopener noreferrer" className="text-onyx-900 hover:opacity-70 transition-opacity">
